...
public interface WordConstant
{
	...
	{ 
		...
		"import", "init", "input", "insert", "instanced", "int", "intrinsic", 
		"invariant", "iterator", "latent", "length", "local", "localized", 
		"name", "native", "nativereplication", "new", "noexport", "none", 
		"noteditinlinenew", "notplaceable", "nousercreate", "operator", 
